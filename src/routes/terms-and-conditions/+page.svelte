...
<svelte:head>
	<title>Terms of Service | Background</title>
</svelte:head>
...
<div class="flex min-h-screen flex-col bg-white text-slate-900 selection:bg-blue-100">
	...
	<main class="grow py-20">
		<article class="container mx-auto px-4 sm:px-6">
			<div class="mx-auto max-w-3xl">
				<header class="mb-12">
					<h1 class="mb-4 text-4xl font-bold tracking-tight text-slate-900 md:text-5xl">
						Terms and Conditions
					</h1>
					<p class="text-sm text-slate-500">Last updated August 01, 2024</p>
				</header>

				<div class="prose max-w-none prose-slate">
					<section class="mb-12">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">AGREEMENT TO OUR LEGAL TERMS</h2>
						<p class="mb-4">We are Background ("Company," "we," "us," "our").</p>
						<p class="mb-4">
							We operate the mobile application Background (the "App"), as well as any other related
						...
						<p class="mb-4">
							You can contact us by email at <a
								...
								class="text-blue-600 hover:underline">info@background-app.de</a
							> or by mail to Josefstraße 192, 52080 Aachen, Germany.
						</p>
						<p class="mb-4">
							These Legal Terms constitute a legally binding agreement made between you, whether
							personally or on behalf of an entity ("you"), and Background, concerning your access
						...
						<p class="mb-4">
							...
							such change. It is your responsibility to periodically review these Legal Terms to
					...
					<section class="mb-12">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">TABLE OF CONTENTS</h2>
						<ul class="list-decimal space-y-2 pl-6">
							<li><a href="#services" class="text-blue-600 hover:underline">OUR SERVICES</a></li>
							<li>
								<a href="#intellectual-property" class="text-blue-600 hover:underline"
									>INTELLECTUAL PROPERTY RIGHTS</a
								>
							</li>
							<li>
								<a href="#user-representations" class="text-blue-600 hover:underline"
									>USER REPRESENTATIONS</a
								>
							</li>
							<li>
								<a href="#user-registration" class="text-blue-600 hover:underline"
									>USER REGISTRATION</a
								>
							</li>
							<li>
								<a href="#prohibited-activities" class="text-blue-600 hover:underline"
									>PROHIBITED ACTIVITIES</a
								>
							</li>
							<li>
								<a href="#user-contributions" class="text-blue-600 hover:underline"
									>USER GENERATED CONTRIBUTIONS</a
								>
							</li>
							<li>
								<a href="#contribution-license" class="text-blue-600 hover:underline"
									>CONTRIBUTION LICENSE</a
								>
							</li>
							<li>
								<a href="#mobile-license" class="text-blue-600 hover:underline"
									>MOBILE APPLICATION LICENSE</a
								>
							</li>
							<li>
								<a href="#third-party" class="text-blue-600 hover:underline"
									>THIRD-PARTY WEBSITES AND CONTENT</a
								>
							</li>
							<li><a href="#advertisers" class="text-blue-600 hover:underline">ADVERTISERS</a></li>
							<li>
								<a href="#management" class="text-blue-600 hover:underline">SERVICES MANAGEMENT</a>
							</li>
							<li><a href="#privacy" class="text-blue-600 hover:underline">PRIVACY POLICY</a></li>
							<li>
								<a href="#copyright" class="text-blue-600 hover:underline"
									>COPYRIGHT INFRINGEMENTS</a
								>
							</li>
							<li>
								<a href="#termination" class="text-blue-600 hover:underline">TERM AND TERMINATION</a
								>
							</li>
							<li>
								<a href="#modifications" class="text-blue-600 hover:underline"
									>MODIFICATIONS AND INTERRUPTIONS</a
								>
							</li>
							<li>
								<a href="#governing-law" class="text-blue-600 hover:underline">GOVERNING LAW</a>
							</li>
							<li>
								<a href="#dispute-resolution" class="text-blue-600 hover:underline"
									>DISPUTE RESOLUTION</a
								>
							</li>
							<li><a href="#corrections" class="text-blue-600 hover:underline">CORRECTIONS</a></li>
							<li><a href="#disclaimer" class="text-blue-600 hover:underline">DISCLAIMER</a></li>
							<li>
								<a href="#liability" class="text-blue-600 hover:underline"
									>LIMITATIONS OF LIABILITY</a
								>
							</li>
							<li>
								<a href="#indemnification" class="text-blue-600 hover:underline">INDEMNIFICATION</a>
							</li>
							<li><a href="#user-data" class="text-blue-600 hover:underline">USER DATA</a></li>
							<li>
								<a href="#electronic-communications" class="text-blue-600 hover:underline"
									>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a
								>
							</li>
							<li>
								<a href="#california" class="text-blue-600 hover:underline"
									>CALIFORNIA USERS AND RESIDENTS</a
								>
							</li>
							<li>
								<a href="#miscellaneous" class="text-blue-600 hover:underline">MISCELLANEOUS</a>
							</li>
							<li><a href="#contact" class="text-blue-600 hover:underline">CONTACT US</a></li>
						</ul>
					</section>

					<section id="services" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">1. OUR SERVICES</h2>
						<p class="mb-4">
					...
					<section id="intellectual-property" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">2. INTELLECTUAL PROPERTY RIGHTS</h2>
						<h3 class="mb-2 text-xl font-semibold">Our intellectual property</h3>
						<p class="mb-4">
						...
						<h3 class="mb-2 text-xl font-semibold">Your use of our Services</h3>
						<p class="mb-4">
						...
						<p class="mb-4">
							...
							in this section or elsewhere in our Legal Terms, please address your request to: <a
								href="mailto:info@background-app.de"
								class="text-blue-600 hover:underline">info@background-app.de</a
						...
						<h3 class="mb-2 text-xl font-semibold">Your submissions and contributions</h3>
						<p class="mb-4">
						...
						<p class="mb-4">
							<strong>When you post Contributions, you grant us a license:</strong> By posting any Contributions,
							...
							sell, resell, publish, broadcast, retitle, store, publicly perform, publicly display, reformat,
							...
							to sublicense the licenses granted in this section. Our use and distribution may occur in
					...
					<section id="user-representations" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">3. USER REPRESENTATIONS</h2>
						<p class="mb-4">
							...
							these Legal Terms; (4) you are not under the age of 13; (5) you are not a minor in the
							jurisdiction in which you reside, or if a minor, you have received parental permission
							to use the Services; (6) you will not access the Services through automated or
							non-human means, whether through a bot, script or otherwise; (7) you will not use the
							Services for any illegal or unauthorized purpose; and (8) your use of the Services
					...
					<section id="user-registration" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">4. USER REGISTRATION</h2>
						<p>
					...
					<section id="prohibited-activities" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">5. PROHIBITED ACTIVITIES</h2>
						<p class="mb-4">
						...
						<ul class="list-disc space-y-2 pl-6">
							...
							<li>Publish content for which you do not have the right to share it.</li>
						</ul>
					</section>

					<section id="user-contributions" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">6. USER GENERATED CONTRIBUTIONS</h2>
						<p class="mb-4">
					...
					<section id="contribution-license" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">7. CONTRIBUTION LICENSE</h2>
						<p class="mb-4">
					...
					<section id="mobile-license" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">8. MOBILE APPLICATION LICENSE</h2>
						<h3 class="mb-2 text-xl font-semibold">Use License</h3>
						<p class="mb-4">
						...
						<h3 class="mb-2 text-xl font-semibold">Apple and Android Devices</h3>
						<p class="mb-4">
					...
					<section id="third-party" class="mb-12 scroll-mt-24">
					...
					<section id="advertisers" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">10. ADVERTISERS</h2>
						<p>
					...
					<section id="management" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">11. SERVICES MANAGEMENT</h2>
						<p class="mb-4">
					...
					<section id="privacy" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">12. PRIVACY POLICY</h2>
						<p class="mb-4">
							We care about data privacy and security. Please review our Privacy Policy: <a
								href="https://background-app.de/privacy-policy-app/"
								class="text-blue-600 hover:underline"
								>https://background-app.de/privacy-policy-app/</a
							...
							Germany and United States. If you access the Services from any other region of the
							world with laws or other requirements governing personal data collection, use, or
							disclosure that differ from applicable laws in Germany and United States, then through
							your continued use of the Services, you are transferring your data to Germany and
							United States, and you expressly consent to have your data transferred to and
							processed in Germany and United States. Further, we do not knowingly accept, request,
							or solicit information from children or knowingly market to children. Therefore, in
							accordance with the U.S. Children’s Online Privacy Protection Act, if we receive
							actual knowledge that anyone under the age of 13 has provided personal information to
					...
					<section id="copyright" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">13. COPYRIGHT INFRINGEMENTS</h2>
						<p>
					...
					<section id="termination" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">14. TERM AND TERMINATION</h2>
						<p class="mb-4">
					...
					<section id="modifications" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">
					...
					<section id="governing-law" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">16. GOVERNING LAW</h2>
						<p>
							These Legal Terms are governed by and interpreted following the laws of Germany, and
							...
							provisions of the law in your country to residence. Background and yourself both agree
							to submit to the non-exclusive jurisdiction of the courts of Aachen, which means that
							you may make a claim to defend your consumer protection rights in regards to these
							Legal Terms in Germany, or in the EU country in which you reside.
						</p>
					</section>

					<section id="dispute-resolution" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">17. DISPUTE RESOLUTION</h2>
						<h3 class="mb-2 text-xl font-semibold">Informal Negotiations</h3>
						<p class="mb-4">
						...
						<h3 class="mb-2 text-xl font-semibold">Binding Arbitration</h3>
						<p class="mb-4">
							...
							clause constitutes acceptance. The seat of arbitration shall be Aachen, Germany,
							Germany. The language of the proceedings shall be German. Applicable rules of
							substantive law shall be the law of Germany.
						</p>

						<h3 class="mb-2 text-xl font-semibold">Restrictions</h3>
						<p class="mb-4">
					...
					<section id="corrections" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">18. CORRECTIONS</h2>
						<p>
					...
					<section id="disclaimer" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">19. DISCLAIMER</h2>
						<p class="mb-4">
					...
					<section id="liability" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">20. LIMITATIONS OF LIABILITY</h2>
						<p>
							...
							YOU TO US OR 10. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS
					...
					<section id="indemnification" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">21. INDEMNIFICATION</h2>
						<p>
					...
					<section id="user-data" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">22. USER DATA</h2>
						<p>
					...
					<section id="electronic-communications" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">
					...
					<section id="california" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">
					...
					<section id="miscellaneous" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">25. MISCELLANEOUS</h2>
						<p class="mb-4">
					...
					<section id="contact" class="mb-12 scroll-mt-24">
						<h2 class="mb-4 text-2xl font-bold text-slate-900">26. CONTACT US</h2>
						<p class="mb-4">
							In order to resolve a complaint regarding the Services or to receive further
							information regarding use of the Services, please contact us at:
						</p>
						<div class="rounded-lg bg-slate-50 p-6">
							<p class="font-bold">Background by Fulton & Bock GbR</p>
							<p>Josefstr. 192, 52080 Aachen</p>
							<p class="mt-2">
								Email: <a href="mailto:info@background-app.de" class="text-blue-600 hover:underline"
